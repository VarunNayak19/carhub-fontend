            ...
            <Dialog as='div' className='relative z-10' onClose={closeModal}>
                ...
                <div className='fixed inset-0 overflow-y-auto'>
                    <div className='flex min-h-full items-center justify-center p-4 text-center'>
                        ...
                        >
                            <div className="h-auto w-auto p-3 rounded-2xl bg-white shadow-xl">
                                <Dialog.Panel className='scrollbar-custom-css relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left  transition-all flex flex-col gap-5'>
                                    <button
                                        type='button'
                                    ...
                                    <div className='flex-1 flex flex-col gap-2 pb-10'>
                                ...
                                <div className="fixed w-100 bottom-0 left-0 right-0 px-8 py-4 bg-white">
                                        <CustomButton
                                            title='Book Now'
                                            containerStyles='w-full py-[16px] rounded-full bg-primary-blue'
                                            textStyles='text-white text-[14px] leading-[17px] font-bold'
                                            rightIcon='/right-arrow.svg'
                                            handleClick={() => router.push('/book-now')}
                                        />
                                </div>
                            </div>
                        </Transition.Child>
